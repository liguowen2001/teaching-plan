...
export class AddComponent implements OnInit {
  ...
  onSubmit(formGroup: FormGroup): void {
    ...
    this.courseService.save(newCourse)
      .subscribe(courseId => {
        this.teachingPlanService.save({name: "test"});
        //this.saveTeachingPlan(courseId);
